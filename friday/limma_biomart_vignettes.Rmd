...
Note: Throughout, text taken directly from the vignettes will be shown in <span style="font-family:georgia"</span> georgia font</span> and code/output from the limma User's guide will be shown with a blue background. Everything else is my commentary/additions.
